...
#define MULTIPLEXER_DELAY  2 //How many microseconds should be delayed between multiplexer reads
...
#define CLAMP_MIN -5000  //the minimum value from the flexion sensors
#define CLAMP_MAX 25000  //the maximum value from the flexion sensors
